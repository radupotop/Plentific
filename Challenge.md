...
Field operatives complete work orders on a mobile app. Many operatives use the system
concurrently during the workday.
We want to introduce a new Stock & Materials Management module to track materials held
in:
...
● Must prevent negative stock beyond a defined tolerance (candidate to propose
...
Also explain trade-offs between ledger-only vs persisted balances vs materialised
views/snapshots
